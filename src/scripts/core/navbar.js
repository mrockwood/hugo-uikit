...
export default {
    ...
    data: {
        dropdown: '.c-navbar-nav > li',
        align: !isRtl ? 'left' : 'right',
        clsDrop: 'c-navbar-dropdown',
        mode: undefined,
        offset: undefined,
        delayShow: undefined,
        delayHide: undefined,
        ...
        duration: 200,
        forceHeight: true,
        selMinHeight: '.c-navbar-nav > li > a, .c-navbar-item, .c-navbar-toggle'
    },
    ...
    beforeConnect() {
        ...
        this.dropbar = dropbar && (query(dropbar, this.$el) || $('+ .c-navbar-dropbar', this.$el) || $('<div></div>'));

        if (this.dropbar) {

            addClass(this.dropbar, 'c-navbar-dropbar');

            if (this.dropbarMode === 'slide') {
                addClass(this.dropbar, 'c-navbar-dropbar-slide');
            }
        }
