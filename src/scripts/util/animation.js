    ...
    return Promise.all(toNodes(element).map(element =>
        new Promise((resolve, reject) => {
            ...
            once(element, 'transitionend transitioncanceled', ({type}) => {
                clearTimeout(timer);
                removeClass(element, 'c-transition');
                css(element, {
                    'transition-property': '',
                    'transition-duration': '',
...
export const Transition = {
    ...
    inProgress(element) {
        return hasClass(element, 'c-transition');
    }

};

const animationPrefix = 'c-animation-';
const clsCancelAnimation = 'c-cancel-animation';
