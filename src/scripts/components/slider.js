...
export default {
    ...
    data: {
        center: false,
        sets: false,
        attrItem: 'c-slider-item',
        selList: '.c-slider-items',
        selNav: '.c-slider-nav',
        clsContainer: 'c-slider-container',
        Transitioner
    },
    ...
    update: {
        ...
        write() {
            ...
            $$(`[${this.attrItem}],[data-${this.attrItem}]`, this.$el).forEach(el => {
                ...
                this.maxIndex && toggleClass(el, 'c-hidden', isNumeric(index) && (this.sets && !includes(this.sets, toFloat(index)) || index > this.maxIndex));
            });
