...
export default {
    ...
    data: {
        ...
        group: null,
        pos: 'top-center',
        clsClose: 'c-notification-close',
        clsMsg: 'c-notification-message'
    },
    ...
    created() {
        ...
        if (!containers[this.pos]) {
            containers[this.pos] = append(this.$container, `<div class="c-notification c-notification-${this.pos}"></div>`);
        }
        ...
        this.$mount(append(container,
            `<div class="${this.clsMsg}${this.status ? ` ${this.clsMsg}-${this.status}` : ''}">
                    <a href="#" class="${this.clsClose}" data-c-close></a>
